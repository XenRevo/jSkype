...
public class SendMessagePacket {
    ...
    public Message editMessage(Message msg) {
        ...
        packet.setData("{\"content\":\"" + msg.getMessage() + "\",\"messagetype\":\"RichText\",\"contenttype\":\"text\",\"skypeeditedid\":\"" + msg.getId() + "\"}");
    ...
    public Message sendMessage(Group group, Message msg) {
        ...
        BasePacket packet = new BasePacket(api);
        packet.setType(RequestType.POST);
        packet.setData("{\"content\":\"" + msg.getMessage() + "\",\"messagetype\":\"RichText\",\"contenttype\":\"text\",\"clientmessageid\":\"" + id + "\"}");
